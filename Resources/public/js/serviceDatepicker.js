...
initDatePicker : function(){
    ...
    if ($.datepicker.regional[serviceDatepicker.getLocale(4)] != undefined ){
        $.datepicker.setDefaults( $.datepicker.regional[serviceDatepicker.getLocale(4)] );
    } else if ($.datepicker.regional[serviceDatepicker.getLocale(2)] != undefined){
        $.datepicker.setDefaults( $.datepicker.regional[serviceDatepicker.getLocale(2) ] );
    } else {
        $.datepicker.setDefaults( $.datepicker.regional['']);
    }

    $('.commentsDatePicker').each(function(){
